...
const files = [
  ...
  //   dateadded: "09.15.2023 14:30PM",
  //   size: "1.2GB",
  //   kind: "FOLDER",
  //   children: [
  //     {
  //       name: "STARRY NIGHT - VAN GOGH.JPG",
  //       dateadded: "09.15.2023 14:32PM",
  //       size: "5MB",
  //       kind: "IMAGE",
  //     },
  //     {
  //       name: "THE GREAT WAVE - HOKUSAI.JPG",
  //       dateadded: "09.15.2023 14:35PM",
  //       size: "4MB",
  //       kind: "IMAGE",
  //     },
  //     {
  //       name: "GUERNICA - PICASSO.JPG",
  //       dateadded: "09.15.2023 14:40PM",
  //       size: "6MB",
  //       kind: "IMAGE",
  //     },
  //     {
  //       name: "ART HISTORY NOTES.TXT",
  //       dateadded: "09.15.2023 15:00PM",
  //       size: "50KB",
  //       kind: "TEXT",
  //     },
  //   ],
  ...
  // {
  //   name: "NATURE ESCAPES",
  //   dateadded: "10.02.2023 09:15AM",
  //   size: "3.5GB",
  //   kind: "FOLDER",
  //   children: [
  //     {
  //       name: "YOSEMITE FALLS.MP4",
  //       dateadded: "10.02.2023 09:20AM",
  //       size: "1.2GB",
  //       kind: "VIDEO",
  //     },
  //     {
  //       name: "RAINFOREST SOUNDS.MP3",
  //       dateadded: "10.02.2023 09:25AM",
  //       size: "15MB",
  //       kind: "AUDIO",
  //     },
  //     {
  //       name: "NORTHERN LIGHTS.JPG",
  //       dateadded: "10.02.2023 09:30AM",
  //       size: "8MB",
  //       kind: "IMAGE",
  //     },
  //     {
  //       name: "HIKING TRAILS WISHLIST.TXT",
  //       dateadded: "10.02.2023 10:00AM",
  //       size: "30KB",
  //       kind: "TEXT",
  //     },
  //   ],
  ...
  //   dateadded: "11.11.2023 18:45PM",
  //   size: "2.3GB",
  //   kind: "FOLDER",
  //   children: [
  //     {
  //       name: "HOMEMADE RAMEN.JPG",
  //       dateadded: "11.11.2023 18:50PM",
  //       size: "4MB",
  //       kind: "IMAGE",
  //     },
  //     {
  //       name: "SOURDOUGH RECIPE.TXT",
  //       dateadded: "11.11.2023 19:00PM",
  //       size: "20KB",
  //       kind: "TEXT",
  //     },
  //     {
  //       name: "WINE TASTING NOTES.TXT",
  //       dateadded: "11.11.2023 19:15PM",
  //       size: "40KB",
  //       kind: "TEXT",
  //     },
  //     {
  //       name: "FARMERS MARKET HAUL.MP4",
  //       dateadded: "11.11.2023 19:30PM",
  //       size: "800MB",
  //       kind: "VIDEO",
  //     },
  //   ],
  ...
  // {
  //   name: "LITERARY GEMS",
  //   dateadded: "12.20.2023 21:00PM",
  //   size: "500MB",
  //   kind: "FOLDER",
  //   children: [
  //     {
  //       name: "1984 - GEORGE ORWELL.TXT",
  //       dateadded: "12.20.2023 21:05PM",
  //       size: "1MB",
  //       kind: "TEXT",
  //     },
  //     {
  //       name: "THE ALCHEMIST QUOTES.TXT",
  //       dateadded: "12.20.2023 21:10PM",
  //       size: "50KB",
  //       kind: "TEXT",
  //     },
  //     {
  //       name: "FAVORITE POEMS.TXT",
  //       dateadded: "12.20.2023 21:15PM",
  //       size: "200KB",
  //       kind: "TEXT",
  //     },
  //     {
  //       name: "BOOK READING LIST.TXT",
  //       dateadded: "12.20.2023 21:20PM",
  //       size: "30KB",
  //       kind: "TEXT",
  //     },
  //   ],
  // },
  // {
  //   name: "MUSIC THAT MOVES",
  //   dateadded: "01.05.2024 16:30PM",
  //   size: "1.8GB",
  //   kind: "FOLDER",
  //   children: [
  //     {
  //       name: "CLASSICAL PLAYLIST.MP3",
  //       dateadded: "01.05.2024 16:35PM",
  //       size: "500MB",
  //       kind: "AUDIO",
  //     },
  //     {
  //       name: "JAZZ COLLECTION.MP3",
  //       dateadded: "01.05.2024 16:40PM",
  //       size: "700MB",
  //       kind: "AUDIO",
  //     },
  //     {
  //       name: "AMBIENT SOUNDS FOR CODING.MP3",
  //       dateadded: "01.05.2024 16:45PM",
  //       size: "600MB",
  //       kind: "AUDIO",
  //     },
  //     {
  //       name: "CONCERT MEMORIES.JPG",
  //       dateadded: "01.05.2024 17:00PM",
  //       size: "10MB",
  //       kind: "IMAGE",
  //     },
  //   ],
  ...
  // {
  //   name: "TRAVEL DIARIES",
  //   dateadded: "02.14.2024 10:00AM",
  //   size: "4.5GB",
  //   kind: "FOLDER",
  //   children: [
  //     {
  //       name: "TOKYO STREET LIFE.MP4",
  //       dateadded: "02.14.2024 10:05AM",
  //       size: "1.5GB",
  //       kind: "VIDEO",
  //     },
  //     {
  //       name: "SANTORINI SUNSET.JPG",
  //       dateadded: "02.14.2024 10:10AM",
  //       size: "7MB",
  //       kind: "IMAGE",
  //     },
  //     {
  //       name: "NEW YORK CITY TIMELAPSE.MP4",
  //       dateadded: "02.14.2024 10:15AM",
  //       size: "2GB",
  //       kind: "VIDEO",
  //     },
  //     {
  //       name: "TRAVEL BUCKET LIST.TXT",
  //       dateadded: "02.14.2024 10:20AM",
  //       size: "40KB",
  //       kind: "TEXT",
  //     },
  //   ],
